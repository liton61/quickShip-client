        ...
        <div className = "bg-[#000000] text-[#FCFCFC]" >
            <Container>
                <div className="flex justify-between items-center">
                    ...
                    <div className="w-1/2">
                        <h1 className="text-4xl font-extrabold text-justify">Quick Ship provides logistics support in all 64 districts and 493 sub districts across Bangladesh</h1>
