                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    <div className="card">
                        ...
                        <div className="items-center text-center">
                            <h2 className="card-title font-bold text-4xl mb-5">
                                Super Fast Delivery
                            </h2>
                    ...
                    <div className="card">
                        ...
                        <div className="items-center text-center">
                            <h2 className="card-title font-bold text-4xl mb-5">Parcel Safety</h2>
                            <p className="text-lg text-justify">
                    ...
                    <div className="card">
                        ...
                        <div className="items-center text-center">
                            <h2 className="card-title font-bold text-4xl mb-5">Verify Author</h2>
                            <p className="text-lg text-justify">
