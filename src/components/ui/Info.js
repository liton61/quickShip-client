...
const Info = () => {
  return (
    <div className="bg-base-200 py-16 hidden lg:flex">
      <div className="container mx-auto lg:px-20 px-5">
        <div className="hero  lg:h-[50vh]" style={{ backgroundImage: 'url(https://i.ibb.co/J5zD6Xk/architect.png)' }}>

          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-md">
              <p>WHY WE ARE BEST</p>
              <h1 className="mb-5 text-xl lg:text-3xl font-bold">Why You Choose Us</h1>
